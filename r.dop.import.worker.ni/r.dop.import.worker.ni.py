...
# %Module
# % description: Downloads and imports single Digital Orthophotos (DOPs) in Niedersachsen
# % keyword: imagery
# % keyword: download
# % keyword: DOP
# %end
...
def main():
    """Main function of r.dop.import.worker.ni"""
    ...
    new_rm_rast = rescale_to_1_255("NI", raster_name)
