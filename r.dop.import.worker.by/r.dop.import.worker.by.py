...
# %Module
# % description: Downloads and imports single Digital Orthophotos (DOPs) in Bayern
# % keyword: imagery
# % keyword: download
# % keyword: DOP
# %end
...
def main():
    """Main function of r.dop.import.worker.by"""
    ...
    new_rm_rast = rescale_to_1_255("BY", raster_name, extension="num")
